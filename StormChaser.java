...
public class StormChaser {
   ...
   //try and catch tests the data file and allows for an error message
...
public static Storm GetStorm( Scanner fileInput ) 
{
    ...
    //Makes array indexes easier to read; variables are final so that they cannot be changed
    final int STORMID = 0;
    final int NAME = 1;
...
public static void DisplayStorms( String title, Storm[] List, int nStorms ) 
{
   ...
   "-------------------------------------------------------------------------");
    ...
    {
        // Print out one Storm
        // Here we take an object, system.out.println(object.toString) , calling toString method and its gonna return the contents of that object and print it out
